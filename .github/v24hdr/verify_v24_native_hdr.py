...
required = {
    ...
    'source/d3d12/v24hdr_sidecar_hotfix5.hpp': [
        ...
        'KAIOZEN V24 HDR POLISH HOTFIX16: ACTIVE',
    ...
    'source/dxgi/dxgi_swapchain.cpp': [
        ...
        'KAIOZEN V24 HDR OUTPUT HOTFIX16: FINAL_PROXY_DRAW_DEFER',
...
if 'v24hdr_hotfix13_draw_fail("CLONE_NOT_PRESENT")' in swap:
    fail('HOTFIX16_CLONE_NOT_PRESENT_STILL_FATAL=FAIL')
if 'v24hdr_hotfix16_draw_defer("CLONE_NOT_PRESENT")' not in swap:
    fail('HOTFIX16_CLONE_NOT_PRESENT_DEFER_MISSING=FAIL')
...
print('V24HDR16_VERIFY_PROXY_NOT_PRESENT_DEFER=PASS')
print('V24HDR16_VERIFY_CALIBRATION_PROFILE=PASS')
