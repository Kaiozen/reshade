...
required = {
    ...
    'source/dxgi/dxgi_swapchain.cpp': [
        ...
        'v24hdr_hotfix12_final_proxy_draw(_orig, _direct3d_command_queue_impl);',
...
final_proxy = swap.find('v24hdr_hotfix12_final_proxy_draw(_orig, _direct3d_command_queue_impl);')
...
if 'static_cast<D3D12CommandQueue *>(_direct3d_command_queue)' in swap:
    fail('HOTFIX12B_PROXY_QUEUE_REGRESSION=FAIL')
